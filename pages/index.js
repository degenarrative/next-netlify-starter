      ...
      <main>
        ...
        <div className="main-content wrapper">
          <div className="main-text">
            ...
            <p>
              Jacob Stephens is a visionary creative technologist with over two decades of experience in digital experiences and installations. His expertise spans animation, projection mapping, computer graphics, and visual programming, resulting in awe-inspiring immersive experiences and interactive data visualizations. With a BFA in Film and Television from NYU, Jacob has worked with top companies such as Facebook, Gensler, and Lucasfilm, creating experiences that connect the emotive aspects of animation and motion design into creative coding and digital interactions. As an early adopter of cryptocurrency and digital collectibles, Jacob brings a unique perspective to his work, creating intriguing, and delightful ways to interact with digital assets and decentralized property ownership.
            </p>
            <p>
              From a childhood realization that money was just a physical representation of an abstract idea to a career exploring the intersection of art and commerce, Jacob Stephens is now at the forefront of the emerging field of AI-driven digital assets. As a leading creative technologist with over two decades of experience, Jacob brings a unique perspective to his work, charting a new course for the future of creativity and commerce.
            </p>
          </div>
